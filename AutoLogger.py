...
"""
    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(1) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)

    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(2) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)

    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(3) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)




    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div.list-details-6h9smn > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(14) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)




    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div.list-details-6h9smn > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(25) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)





    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div.list-details-6h9smn > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(47) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)




    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div.list-details-6h9smn > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(59) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)



    

    #__next > div > div.page-container.flex.flex-col.flex-grow.items-center > div.list-details-6h9smn > section > div.flex.relative.max-w-full.overflow-x-auto.overflow-y-visible.print\:scrollbar.print\:scrollbar-w-0 > table > tbody > tr:nth-child(67) > td.list-geocache-details > div > div.geocache-details > div.geocache-meta > span:nth-child(2)
